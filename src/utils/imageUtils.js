 ...
 */
const getPreviewImagePath = (designId, view) => {
 ...
 */
const generatePreviewImages = async (design) => {
  try {
    ...
    for (const view of views) {
      ...
      let baseImage;
      try {
        baseImage = await loadImage(baseImagePaths[view]);
      } catch (error) {
      ...
      previewUrls[view] = `/uploads/designs/previews/design-${design.shareableId}-${view}.jpg`;
    }
